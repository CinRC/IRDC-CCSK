...
public class ActionTest {
  ...
  public void testBasicActions() {
    ...
    ProcessContainer p = new ProcessContainer(new CCSParser().parseLine("a.b").export());
    p.act(a);
    assert p.canAct(b);
  }
  ...
  public void testAdvancedActions() {
    ...
    ProcessContainer p = new ProcessContainer(new CCSParser().parseLine("a.b+c.d").export());
