...
public class EnumerationTest {
  ...
  public void testEnumerate() {
    ...
    Process p = new CCSParser().parseLine("a.b|c.d");
    Process pc = p.clone();
  ...
  public void test() {
    ...
    ProcessContainer p = new ProcessContainer(new CCSParser().parseLine("a.b|'a.c"));
    Label a, aa, b, c;
  ...
  public void testTree() {
    ...
    p = new CCSParser().parseLine("a.(c|d)");
    System.out.printf("Testing enumeration of %s...\n", p.represent());
    node = new LTTNode(p);
    node.enumerate(true);
    System.out.println(node);
    ...
    assert (node.getMaxDepth() == 3);
        ...
        /*p = new CCSParser().parseLine("(d.(a+c)) | ('a.( (c|b)|'b) | (a+'b) )");
        System.out.printf("Testing enumeration of %s...\n", p.represent());
        node = new LTTNode(p);
        node.enumerate();
        System.out.println(node);
  ...
  public void regenerationTest(){
    ...
    Process p = new CCSParser().parseLine("a.b.P");
    Process p2 = p.clone();
